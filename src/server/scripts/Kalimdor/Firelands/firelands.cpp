...
public:
    ...
    CreatureAI *GetAI(Creature *pCreature) const {
        return GetFirelandsAI<npc_firelands_ancient_core_houndAI>(pCreature);
    }
...
public:
    ...
    CreatureAI *GetAI(Creature *pCreature) const {
        return GetFirelandsAI<npc_firelands_ancient_lava_dwellerAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI *GetAI(Creature *pCreature) const {
        return GetFirelandsAI<npc_firelands_fire_scorpionAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI *GetAI(Creature *pCreature) const {
        return GetFirelandsAI<npc_firelands_molten_lordAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI *GetAI(Creature *creature) const {
        return GetFirelandsAI<npc_harbinger_legendaryAI>(creature);
    }
};
    ...
    struct npc_tormented_protectorAI : public ScriptedAI {
        ...
        void UpdateAI(uint32 const diff) override {
            ...
            if (me->HealthBelowPct(20)) {
                ...
                _events.CancelEvent(
                        EVENT_BLAZING_STOMP); // Cancel Events, seems he need the combat active for the Event
...
public:
    ...
    CreatureAI *GetAI(Creature *creature) const {
        return GetFirelandsAI<npc_tormented_protectorAI>(creature);
    }
};
...
public:
    ...
    CreatureAI *GetAI(Creature *creature) const {
        return GetFirelandsAI<npc_burning_treantAI>(creature);
    }
};
...
public:
    ...
    class spell_firelands_ancient_core_hound_dinner_time_AuraScript : public AuraScript {
        ...
        void Register() {
            OnEffectApply +=
                    AuraEffectApplyFn(spell_firelands_ancient_core_hound_dinner_time_AuraScript::OnApply, EFFECT_0,
                                      SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove +=
                    AuraEffectRemoveFn(spell_firelands_ancient_core_hound_dinner_time_AuraScript::OnRemove, EFFECT_0,
                                       SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
        }
    };
...
public:
    ...
    class spell_firelands_ancient_core_hound_flame_breath_AuraScript : public AuraScript {
        ...
        void Register() {
            OnEffectApply +=
                    AuraEffectApplyFn(spell_firelands_ancient_core_hound_flame_breath_AuraScript::OnApply, EFFECT_0,
                                      SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove +=
                    AuraEffectRemoveFn(spell_firelands_ancient_core_hound_flame_breath_AuraScript::OnRemove, EFFECT_0,
                                       SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
        }
    };
...
public:
    ...
    class spell_firelands_ancient_lava_dweller_lava_shower_AuraScript : public AuraScript {
        ...
        void Register() {
            OnEffectPeriodic +=
                    AuraEffectPeriodicFn(spell_firelands_ancient_lava_dweller_lava_shower_AuraScript::PeriodicTick,
...
public:
    ...
    class spell_firelands_fire_turtle_hatchling_shell_spin_AuraScript : public AuraScript {
        ...
        void Register() {
            OnEffectApply +=
                    AuraEffectApplyFn(spell_firelands_fire_turtle_hatchling_shell_spin_AuraScript::OnApply, EFFECT_0,
                                      SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove +=
                    AuraEffectRemoveFn(spell_firelands_fire_turtle_hatchling_shell_spin_AuraScript::OnRemove, EFFECT_0,
                                       SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
        }
    };
...
public:
    ...
    class spell_firelands_flame_archon_fiery_torment_AuraScript : public AuraScript {
        ...
        void Register() {
            OnEffectApply +=
                    AuraEffectApplyFn(spell_firelands_flame_archon_fiery_torment_AuraScript::OnApply, EFFECT_0,
                                      SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove +=
                    AuraEffectRemoveFn(spell_firelands_flame_archon_fiery_torment_AuraScript::OnRemove, EFFECT_0,
                                       SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            OnEffectPeriodic +=
                    AuraEffectPeriodicFn(spell_firelands_flame_archon_fiery_torment_AuraScript::PeriodicTick, EFFECT_0,
...
public:
    ...
    class spell_firelands_molten_lord_summon_lava_jets_SpellScript : public SpellScript {
        ...
        void Register() {
            OnEffectHitTarget +=
                    SpellEffectFn(spell_firelands_molten_lord_summon_lava_jets_SpellScript::HandleScript, EFFECT_0,
                                  SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    ...
    class spell_branch_of_nordrassil_summon_SpellScript : public SpellScript {
        ...
        void Register() {
            OnEffectHitTarget +=
                    SpellEffectFn(spell_branch_of_nordrassil_summon_SpellScript::AfterCast, EFFECT_0,
                                  SPELL_EFFECT_DUMMY);
        }
...
public:
    ...
    struct mob_fl_teleportAI : public ScriptedAI {
        ...
        void MoveInLineOfSight(Unit *who) override {
            ...
            if (me->GetExactDist(who) <=
                17.0f) // we use here not GetExactDist2d because player fly also into the FL portal

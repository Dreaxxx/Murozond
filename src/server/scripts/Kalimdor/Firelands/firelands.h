...
enum FirelandsPathIDs
{
    PATH_SHANNOX = 4004290,
};

enum FirelandsDataVar
{
    DATA_PHASE,
};
...
template<class AI>
AI* GetFirelandsAI(GameObject* go)
{
    return GetInstanceAI<AI>(go, FirelandsScriptName);
}
